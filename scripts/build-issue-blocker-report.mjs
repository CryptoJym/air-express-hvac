...
<body>
  ...
  <main>
    ...
    <section class="grid">
      ...
      <article class="card"><h3>Attribution</h3><div class="metric bad">${escapeHtml(seoAudit.scores?.attribution)}</div><p>Blocked by Google scopes, New Reward mapping, live tag sync, and ServiceTitan export proof.</p></article>
    </section>
